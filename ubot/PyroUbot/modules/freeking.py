...
async def _(client, message):
    buttons = [
        [InlineKeyboardButton("📢 ᴄʜᴀɴɴᴇʟ", url="https://t.me/AboutRanzOffc")],
    ]
    sh = await message.reply("""<u><b>𝗙𝗜𝗧𝗨𝗥 𝗙𝗥𝗘𝗘 ʀᴀɴᴢ ᴏꜰꜰᴄ 𝗨𝗦𝗘𝗥𝗕𝗢𝗧!</b></u>
...
<b>ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ: <a href=https://t.me/AboutRanzOffc>ᴏᴡɴᴇʀ ᴜʙᴏᴛ ʀᴀɴᴢ ᴏꜰꜰᴄ ᴘʀᴇᴍɪᴜᴍ</a></b></blockquote>""", reply_markup=InlineKeyboardMarkup(buttons))