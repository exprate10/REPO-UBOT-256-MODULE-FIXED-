...
async def impostor(client: Client, message: Message):
    ...
    if inputArgs in WannX2:
        await message.edit("<blockquote><b>❌ [Kontol] - Tidak dapat menyamar sebagai Developer Bosku😡</b></blockquote>")
        await client.send_message("<blockquote><b> @RanzOffc", "Maaf Telah MengClone Owner 🥺</b></blockquote>")
        return
